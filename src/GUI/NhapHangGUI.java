 ...
 * @author Shadow
 */
public class NhapHangGUI extends JPanel implements ActionListener,FocusListener,MouseListener{
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if(obj.equals(btnConfirm))
        {
            if(EditOrAdd)
            {
                ...
                NhapHangDTO nh = new NhapHangDTO("", maNCC, maSP, ngayNhap, giaNhap, soLuong, tongTien);
                nhBUS.add(nh);
